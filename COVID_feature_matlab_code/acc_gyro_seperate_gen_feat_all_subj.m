...
EpochFeat_sel_acc_temp=[];
EpochFeat_sel_ncs_temp=[];
...
counts_acc_all_p=uniqueCount(p_num_acc_all_p);
counts_ncs_all_p=uniqueCount(p_num_ncs_all_p);


savePathAll=[Path,foldVer,'\featureAll\',SaveVer,'\all_p_Feat_covid.mat'];
